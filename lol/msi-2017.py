...
body.append(tournament.create_single_match_section(msi['stages'][2]))
body.append(tournament.create_group_stage_section(msi['stages'][3]))
body.append(tournament.create_knockout_stage_section(msi['stages'][4]))
